...
namespace $safeprojectname$
{
    ...
    public class Plugin
    {
        ...
        public void Init(IPALogger logger, Config conf, Zenjector zenjector)
        {
            ...
            //zenjector.Install<$safeprojectname$AppInstaller>(Location.App);
            //zenjector.Install<$safeprojectname$MenuInstaller>(Location.Menu);
            //zenjector.Install<$safeprojectname$PlayerInstaller>(Location.Player);
        }
